...
//////////////////////////////////////////////////////////////////////////////////
`define DataRamContentLoadPath "Z:\\Share\\lab\\CSRtestALL.data"           //修改此处为测试数据路径
`define InstRamContentLoadPath "Z:\\Share\\lab\\CSRtestALL.inst"           //修改此处为测试数据路径
`define DataRamContentSavePath "Z:\\Share\\lab\\DataRamContent.txt"      //修改此处为测试数据路径
`define InstRamContentSavePath "Z:\\Share\\lab\\InstRamContent.txt"      //修改此处为测试数据路径
// `define DataRamContentLoadPath "D:\\pipeline_cpu\\1testAll.data"           //修改此处为测试数据路径
// `define InstRamContentLoadPath "D:\\pipeline_cpu\\1testAll.inst"           //修改此处为测试数据路径
// `define DataRamContentSavePath "D:\\pipeline_cpu\\DataRamContent.txt"      //修改此处为测试数据路径
// `define InstRamContentSavePath "D:\\pipeline_cpu\\InstRamContent.txt"      //修改此处为测试数据路径
